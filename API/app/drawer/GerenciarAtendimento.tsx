...
export default function GerenciamentoAtendimento() {
  ...
  function abrirAtendente(id: number) {
    router.push({
      pathname: '/modal',
      params: {
        id: id.toString(),
  ...
  function editarAtendente(id: number) {
    router.push({
      pathname: '/modal',
      params: {
        id: id.toString(),
  ...
  // Excluir atendente
  function excluirAtendente(id: number) {
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <View style={styles.card}>
            ...
            <Pressable
              style={styles.info}
              onPress={() => abrirAtendente(item.id)}
            >
            ...
            <Pressable
              ...
              onPress={() => editarAtendente(item.id)}
            >
              <Ionicons
                name="pencil-outline"
                size={24}
            ...
            <Pressable
              style={styles.actionButton}
              onPress={() => excluirAtendente(item.id)}
            >
              <Ionicons
                name="close-outline"
                size={30}
